...
mixin _$TvShows {
 ...
 String get name; String get permalink;@JsonKey(name: 'end_date') String get endDate; String get network;@JsonKey(name: 'image_thumbnail_path') String get imageThumnnailPath; String get status;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TvShows&&(identical(other.name, name) || other.name == name)&&(identical(other.permalink, permalink) || other.permalink == permalink)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.network, network) || other.network == network)&&(identical(other.imageThumnnailPath, imageThumnnailPath) || other.imageThumnnailPath == imageThumnnailPath)&&(identical(other.status, status) || other.status == status));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,permalink,endDate,network,imageThumnnailPath,status);

@override
String toString() {
  return 'TvShows(name: $name, permalink: $permalink, endDate: $endDate, network: $network, imageThumnnailPath: $imageThumnnailPath, status: $status)';
}
...
@useResult
$Res call({
 String name, String permalink,@JsonKey(name: 'end_date') String endDate, String network,@JsonKey(name: 'image_thumbnail_path') String imageThumnnailPath, String status
});
...
/// Create a copy of TvShows
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? permalink = null,Object? endDate = null,Object? network = null,Object? imageThumnnailPath = null,Object? status = null,}) {
  return _then(_self.copyWith(
...
as String,imageThumnnailPath: null == imageThumnnailPath ? _self.imageThumnnailPath : imageThumnnailPath // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String permalink, @JsonKey(name: 'end_date')  String endDate,  String network, @JsonKey(name: 'image_thumbnail_path')  String imageThumnnailPath,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TvShows() when $default != null:
return $default(_that.name,_that.permalink,_that.endDate,_that.network,_that.imageThumnnailPath,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String permalink, @JsonKey(name: 'end_date')  String endDate,  String network, @JsonKey(name: 'image_thumbnail_path')  String imageThumnnailPath,  String status)  $default,) {final _that = this;
switch (_that) {
case _TvShows():
return $default(_that.name,_that.permalink,_that.endDate,_that.network,_that.imageThumnnailPath,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String permalink, @JsonKey(name: 'end_date')  String endDate,  String network, @JsonKey(name: 'image_thumbnail_path')  String imageThumnnailPath,  String status)?  $default,) {final _that = this;
switch (_that) {
case _TvShows() when $default != null:
return $default(_that.name,_that.permalink,_that.endDate,_that.network,_that.imageThumnnailPath,_that.status);case _:
  return null;
...
class _TvShows implements TvShows {
  const _TvShows({this.name = '', this.permalink = '', @JsonKey(name: 'end_date') this.endDate = '', this.network = '', @JsonKey(name: 'image_thumbnail_path') this.imageThumnnailPath = '', this.status = ''});
...
@override@JsonKey(name: 'image_thumbnail_path') final  String imageThumnnailPath;
...
/// Create a copy of TvShows
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? permalink = null,Object? endDate = null,Object? network = null,Object? imageThumnnailPath = null,Object? status = null,}) {
